...
from networks.extra_layers import *
from networks.base_net import VGGBase
from utils.metrics import find_jaccard_overlap
from utils.boxes_utils import create_prior_boxes, cxcy_to_xy, gcxgcy_to_cxcy


class SSD300(nn.Module):
    """
    The SSD300 network - encapsulates the base VGG network, auxiliary, and prediction 
    convolutions.
    """
    ...
    def __init__(self, n_classes, device=torch.device("cuda")):
        ...
        # Prior boxes
        self.priors_cxcy = create_prior_boxes(self.device)
