...
from utils.helpers import label_map, rev_label_map
...
def find_jaccard_overlap(set_1, set_2):
    """
    Find the Jaccard Overlap (IoU) of every box combination between two sets of boxes that are 
    in boundary coordinates.

    :param set_1: set 1, a tensor of dimensions (n1, 4)
    :param set_2: set 2, a tensor of dimensions (n2, 4)
    :return: Jaccard Overlap of each of the boxes in set 1 with respect to each of the boxes 
             in set 2, a tensor of dimensions (n1, n2)
    """
...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties,
    ...
    :param true_labels: list of tensors, one tensor for each image containing actual objects' 
                        labels
    :param true_difficulties: list of tensors, one tensor for each image containing actual 
                              objects' difficulty (0 or 1)
    ...
    for c in range(1, n_classes):
        ...
        for d in range(n_class_detections):
            ...
            if max_overlap.item() > 0.5:
                ...
                if object_difficulties[ind] == 0:
                    ...
                    # Otherwise, it's a false positive (since this object is already accounted)
                    else:
                        false_positives[d] = 1
            # Otherwise, the detection occurs in a different location than the actual object, 
        ...
        # Find the mean of maximum of precisions corresponding to recalls above the threshold 't'
