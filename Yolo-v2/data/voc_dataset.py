...
class VOCDataset(Dataset):
    def __init__(self, root_path="../datasets/VOC2007_train/VOCdevkit", year="2007", mode="train", 
                       image_size=448, is_training = True):
    ...
    def __getitem__(self, item):
        ...
        if self.is_training:
            transformations = Compose([HSVAdjust(), VerticalFlip(), Crop(), 
